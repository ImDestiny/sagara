...
class Config:
    ...
    BOT_TOKEN = environ.get("BOT_TOKEN", "7832360180:AAG47yibMws5UP5EgA933S1oWTHGbNsqzyw") 
    BOT_OWNER_ID = [int(id) for id in environ.get("BOT_OWNER_ID", '486433780').split()]
    BOT_SESSION = environ.get("BOT_SESSION", "fast1") 
    ...
    DATABASE_NAME = environ.get("DATABASE_NAME", "fast1")
